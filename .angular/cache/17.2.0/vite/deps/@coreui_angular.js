...
import {
  ...
  trigger,
  useAnimation
} from "./chunk-OTTMQAF6.js";
import {
  IconDirective
} from "./chunk-KTN6XHFE.js";
import "./chunk-G2USQ5WS.js";
import "./chunk-AAQDBTTA.js";
import {
  AsyncPipe,
  DOCUMENT,
  NgClass,
...
var _CdkMonitorFocus = class _CdkMonitorFocus {
  constructor(_elementRef, _focusMonitor2) {
    this._elementRef = _elementRef;
...
_SharedModule.ɵmod = ɵɵdefineNgModule({
  type: _SharedModule,
  imports: [HtmlAttributesDirective, TemplateIdDirective],
  exports: [HtmlAttributesDirective, TemplateIdDirective]
});
...
_SidebarNavLinkComponent.ɵcmp = ɵɵdefineComponent({
  ...
  dependencies: [RouterModule, RouterLink, RouterLinkActive, HtmlAttributesDirective, IconDirective, NgClass, NgTemplateOutlet, SidebarNavLinkContentComponent, SidebarNavLinkPipe, SidebarNavBadgePipe, SidebarNavIconPipe],
  encapsulation: 2
});
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SidebarNavLinkComponent, [{
    ...
    args: [{
      ...
      providers: [SidebarNavHelper],
      standalone: true,
      imports: [RouterModule, HtmlAttributesDirective, IconDirective, NgClass, NgTemplateOutlet, SidebarNavLinkContentComponent, SidebarNavLinkPipe, SidebarNavBadgePipe, SidebarNavIconPipe],
...
var _TooltipDirective = class _TooltipDirective {
  ...
  addTooltipElement() {
    ...
    this.popperInstance = createPopper(this.hostElement.nativeElement, this.tooltip, __spreadValues({}, this.popperOptions));
    if (!this.visible) {
      this.removeTooltipElement();
      return;
    }
